...
public class TickerDAO extends EgovAbstractDAO {
	...
	public int getTickerListTotCnt(TickerDtlVO purchaseVO) throws Exception {
		return (Integer) select("tickerDao.getTickerListTotCnt", purchaseVO);
	}

	public List<TickerDtlVO> getTickerList(TickerDtlVO purchaseVO) {
		return (List<TickerDtlVO>) list("tickerDao.getTickerList", purchaseVO);
	}
}
