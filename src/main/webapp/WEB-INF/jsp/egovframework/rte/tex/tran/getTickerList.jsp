...
<input type="hidden" name="dlvySe" />
	...
	<div id="title2">
		<ul>
			<li> <img src="<c:url value='/images/egovframework/rte/title_dot.gif'/>" alt=""/> Ticker 목록조회 </li>
		</ul>
	</div>
	<!-- // 타이틀 -->
	<div id="search">
...
<%-- 			<c:set var="sum" value="${0}"/> --%>
				<c:forEach var="result" items="${resultList}" >
					<tr>
						...
						<td align="center" class="listtd"><c:out value="${result.last}"/><spring:message code="cart.won" />&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.volume}"/>&nbsp;</td>
							<td align="center" class="listtd">&nbsp;<spring:message code="cart.won"/></td>
